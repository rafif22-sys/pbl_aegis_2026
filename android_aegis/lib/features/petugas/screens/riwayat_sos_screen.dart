...
import 'widgets/riwayat_sos/sos_top_header.dart';
import 'widgets/riwayat_sos/sos_stat_card.dart';
import 'widgets/riwayat_sos/sos_filter_sheet.dart';
import 'widgets/riwayat_sos/sos_card.dart';
import 'widgets/riwayat_sos/sos_pagination_bar.dart';
import 'widgets/riwayat_sos/sos_empty_error.dart';
    ...
    return Consumer<SosProvider>(
      builder: (context, provider, _) {
        ...
        if (provider.state == SosListState.error) {
          return SosErrorState(message: provider.errorMessage, onRetry: _fetchData);
        }
