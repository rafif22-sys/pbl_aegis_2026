...
function FotoTamu({ url, nama }) {
    ...
    const resolved = !url || err ? null
        ...
        : `https://dwyfjwwgrtdspgdaifyv.supabase.co/storage/v1/object/public/aegis/${url.replace(/^\//, '')}`;
...
function DetailModal({ tamu, onClose, onDelete }) {
    ...
    const fotoUrl = !tamu.foto_tamu ? null
        ...
        : `https://dwyfjwwgrtdspgdaifyv.supabase.co/storage/v1/object/public/aegis/${tamu.foto_tamu.replace(/^\//, '')}`;
